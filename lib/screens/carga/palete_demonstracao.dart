...
class PaleteDemonstracao extends StatefulWidget {
  const PaleteDemonstracao({Key? key, required this.palete}) : super(key: key);

  final Palete palete;

  @override
  State<PaleteDemonstracao> createState() => _PaleteDemonstracaoState();
}

class _PaleteDemonstracaoState extends State<PaleteDemonstracao> {
                    ...
                    children: [
                      ...
                      Table(
                        ...
                        children: [
                          ...
                          ...calibresM
                              .where((ele) => ele.cat1 > 0 || ele.cat2 > 0)
                              .map(
                                (e) => TableRow(children: [
