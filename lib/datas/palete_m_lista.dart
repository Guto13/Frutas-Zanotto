class PaleteMLista {
  ...
  factory PaleteMLista.fromJson(Map<String, dynamic> json) {
    return PaleteMLista(
      id: json['id'],
...
class FrutaPalete {
  ...
  factory FrutaPalete.fromJson(Map<String, dynamic> json) {
    return FrutaPalete(
      id: json['id'],
      nome: json['Nome'],
...
class EmbalagemPalete {
  ...
  factory EmbalagemPalete.fromJson(Map<String, dynamic> json) {
    return EmbalagemPalete(
      id: json['id'],
      nome: json['Nome'],
    );
  }
